...
from .Views import RegistrarIngreso, ListarIngresos, RegistrarSalida

urlpatterns = [
    path('',home),
    path('admin/', admin.site.urls),
    path('Ambientes/RegistrarAmbiente',RegistrarAmbiente),
    path('Ambientes/ListarAmbientes', ListarAmbientes),
    ...
    path('Ingreso/RegistrarIngreso', RegistrarIngreso),
    path('Ingreso/ListarIngresos',ListarIngresos),
    path('Ingreso/RegistrarSalida',RegistrarSalida)
]
